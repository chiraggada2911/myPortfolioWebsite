...
@section('content')
    ...
    @include('admin.alert.alert')
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">{{ __('content.portfolio') }}</h1>
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">{{ __('content.portfolio') }}</h6>
                    </div>
                    <div class="card-body">
                        @if (isset($portfolio))
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="title_bg_name" name="title_bg_name" type="text" class="form-control" value="{{ $portfolio->title_bg_name }}"  placeholder="{{ __('content.enter_title_background') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="title">{{ __('content.title') }} <span class="text-red">*</span></label>
                                            <input id="title" name="title" type="text" class="form-control" value="{{ $portfolio->title }}" placeholder="{{ __('content.enter_title') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
